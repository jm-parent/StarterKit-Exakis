...
namespace StarterKit.Behaviors
{
    public class ENViewTappedBehaviors : Behavior<View>
    {
            public static readonly BindableProperty AnimationTypeProperty =
                BindableProperty.Create(nameof(AnimationType), typeof(AnimationType), typeof(ENViewTappedBehaviors), AnimationType.Fade);
            ...
            public static readonly BindableProperty CommandProperty =
                BindableProperty.Create(nameof(Command), typeof(ICommand), typeof(ENViewTappedBehaviors), null, defaultBindingMode: BindingMode.TwoWay);
            ...
            public static readonly BindableProperty CommandParameterProperty =
                BindableProperty.Create(nameof(CommandParameter), typeof(object), typeof(ENViewTappedBehaviors), null);
            ...
            void View_Tapped(object sender, EventArgs e)
            {
                ...
                Device.BeginInvokeOnMainThread(async () =>
                {
                    try
                    {
                        ...
                        else if (AnimationType == AnimationType.ScaleDown)
                        {
                            await view.ScaleTo(0.95, 100, easing: Easing.Linear);
                            await view.ScaleTo(1, 100, easing: Easing.Linear);
                        }
